...
open class RequestInfoRecord() : UpdatableRecordImpl<RequestInfoRecord>(RequestInfo.REQUEST_INFO), Record6<Long?, Int?, String?, String?, State?, Array<String?>?> {
    ...
    override fun valuesRow(): Row6<Long?, Int?, String?, String?, State?, Array<String?>?> = super.valuesRow() as Row6<Long?, Int?, String?, String?, State?, Array<String?>?>
    ...
    override fun field6(): Field<Array<String?>?> = RequestInfo.REQUEST_INFO.TAGS
    ...
    override fun value6(value: Array<String?>?): RequestInfoRecord {
        this.tags = value
        return this
    }

    override fun values(value1: Long?, value2: Int?, value3: String?, value4: String?, value5: State?, value6: Array<String?>?): RequestInfoRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(guild: Long? = null, request: Int? = null, title: String? = null, detail: String? = null, state: State? = null, tags: Array<String?>? = null): this() {
        this.guild = guild
